...
task :XCSpecs do
  system_or_exit "xcodebuild -workspace Example/Authenticator.xcworkspace -scheme Authenticator-Example -configuration Debug -destination 'name=iPhone 11' clean test GCC_GENERATE_TEST_COVERAGE_FILES=YES | xcpretty -t; test ${PIPESTATUS[0]} -eq 0"
end
